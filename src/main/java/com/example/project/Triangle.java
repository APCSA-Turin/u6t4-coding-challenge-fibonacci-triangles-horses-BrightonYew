...
public class Triangle {
  ...
  public double perimeter() {
    /* IMPLEMENT ME */
    double distance1 = vertices[0].distanceTo(vertices[1]);
    double distance2 = vertices[1].distanceTo(vertices[2]);
    double distance3 = vertices[2].distanceTo(vertices[0]);
